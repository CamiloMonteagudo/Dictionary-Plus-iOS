...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
// Inicia una vista que ocupa el area de la vista superior con un cursor de espera en el madio
- (id)initInTopFrom:(UIView*) view
  {
  UIView* parent = FindTopView( view );
  
  return [self initInView:parent];
  }
