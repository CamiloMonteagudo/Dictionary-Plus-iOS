...
UIColor* ColPanelBck     = [UIColor colorWithRed:0.05 green:0.2 blue:0.75 alpha:0.9];                   // Color de fondo para el menú lateral
UIColor* ColPanelBck2    = [UIColor colorWithRed:0.05 green:0.2 blue:0.75 alpha:1.0];                   // Color de fondo para el menú lateral
